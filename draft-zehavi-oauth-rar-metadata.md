...
* The authentication error code `insufficient_authorization` for use in the `WWW-Authenticate` header. Resource servers SHOULD return `insufficient_authorization` when access is denied due to missing or insufficient authorization details.
